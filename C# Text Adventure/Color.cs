...
public static class Color
{
    ...
    public const string FORE_RED = "\x1B[38;5;001m";            // Hostile NPC
    public const string FORE_GREEN = "\x1B[38;5;002m";          // Friendly NPC
    public const string FORE_YELLOW = "\x1B[38;5;003m";
    public const string FORE_BLUE = "\x1B[38;5;004m";           
    public const string FORE_PURPLE = "\033[38;5;005";
    public const string FORE_CYAN = "\x1B[38;5;006m";           // Default Items
    public const string FORE_LIGHT_GREY = "\x1B[38;5;007m";
    public const string FORE_GREY = "\x1B[38;5;008m";
    public const string FORE_LIGHT_RED = "\x1B[38;5;009m";      // Error, Death
    public const string FORE_LIGHT_GREEN = "\x1B[38;5;010m";    // Money
    ...
    public const string FORE_ORANGE = "\x1B[38;5;208m";         // Armor
